...
|--------------------------------------|------------------------------------------------------------|-----------------------------------------------------------|---------------------------|
| Data Warehouse                       | [Redshift](https://aws.amazon.com/redshift)                | [Big Query]()                                             | [Synapse Analytics (ASA)](https://docs.microsoft.com/en-us/azure/synapse-analytics)|
| FaaS                                 | [Lambda](https://aws.amazon.com/lambda/)                   | [Cloud Functions]()                                       | [Functions](https://docs.microsoft.com/en-us/azure/azure-functions/functions-overview)|
...
| Storage                              | [S3](https://aws.amazon.com/lakeformation)                 | [Cloud Storage](https://cloud.google.com/storage/docs/overview)  | [Blob Storage](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction)|
| Data Lake                            | [Lake Formation](https://aws.amazon.com/s3)                | [Cloud Storage](https://cloud.google.com/storage/docs/overview)  | [Data Lake Storage Gen2](https://docs.microsoft.com/en-us/azure/databricks/data/data-sources/azure/adls-gen2)|
